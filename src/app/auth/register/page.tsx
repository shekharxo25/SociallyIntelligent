  ...
  return (
    <div className="min-h-screen bg-[#030305] text-[#e2e8f0] flex items-center justify-center p-4 tech-grid relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl glass-panel relative z-10 animate-fade-in border border-white/[0.04]">
        ...
        {/* Glowing top line */}
        <div className="absolute top-0 left-10 right-10 h-[1px] bg-gradient-to-r from-transparent via-teal-500 to-transparent" />
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-xl font-bold text-white tracking-tight uppercase display-font">Create Account</h2>
          <span className="text-[9px] uppercase tracking-wider text-teal-400 font-mono font-bold mt-1">Initialize your cognitive workspace</span>
        </div>
        ...
        {successMessage && (
          <div className="mb-5 p-3.5 rounded-xl border border-teal-500/20 bg-teal-500/[0.02] text-teal-400 text-xs font-mono animate-fade-in">
            {successMessage}
          </div>
        )}
